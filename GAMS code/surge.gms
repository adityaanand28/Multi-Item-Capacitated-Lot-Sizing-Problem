...
$call GDXXRW input.xlsx par=f rng=sheet28!a2:b31 rdim=1 cdim=0
$GDXIN input.gdx
$Load f
$GDXIN

Parameter D(t) demand for the item during the time t
$call GDXXRW input.xlsx par=D rng=sheet28!a34:b63 rdim=1 cdim=0
$GDXIN input.gdx
$Load D
$GDXIN
...
$call GDXXRW input.xlsx par=h rng=sheet28!a66:b95 rdim=1 cdim=0
$GDXIN input.gdx
$Load h
$GDXIN
